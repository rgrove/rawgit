...
/**
Matches the beginning of a rawgithub.com URL.

@var {RegExp} REGEX_RAWGITHUB
@final
**/
var REGEX_RAWGITHUB = /^https?:\/\/rawgithub\.com\//i;
...
function parseLine(line) {
    ...
    if (REGEX_RAWGITHUB.test(referrer) && !REGEX_EXTERNAL.test(referrer)) {
        return;
    }
...
function tail(logPath) {
    var tailProcess = spawn('tail', ['-F', '-n', '1000', logPath]),
