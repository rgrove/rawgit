...
module.exports = function (rootUrl) {
    ...
    return function (req, res, next) {
        ...
        request.on('response', function (github) {
            ...
            // NOTE: For now, we always decompress GitHub responses because
            // passing compressed responses to Nginx seems to lead to spurious
            // 504s (possibly because it's not caching them correctly).
